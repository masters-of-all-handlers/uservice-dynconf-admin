...
export const DASHBOARD_CONFIGS_EDIT_URL = (uuid) =>
  `${DASHBOARD_URL}/configs/${uuid}/edit`;
export const DASHBOARD_CONFIGS_CLONE_URL = (uuid) =>
  `${DASHBOARD_URL}/configs/${uuid}/clone`;
